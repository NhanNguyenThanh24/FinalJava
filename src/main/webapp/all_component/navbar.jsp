...
<div class="container-fluid p-3 bg-light">
    <div class="row align-items-center"> <!-- Thêm align-items-center vào đây -->
        <div class="col-md-3 text-success d-flex align-items-center"> <!-- Thêm d-flex và align-items-center -->
            <h3 class="mb-0"> <!-- Thêm mb-0 để bỏ margin bottom mặc định của h3 -->
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
      ...
      <path stroke-linecap="round" stroke-linejoin="round"
        d="M10 16l4-4m0 0l-4-4m4 4H3m13-7h4a2 2 0 012 2v10a2 2 0 01-2 2h-4" />
			...
			<a href="register.jsp" class="button"> <span class="button__text">Register</span> <span
				class="button__icon"> <svg xmlns="http://www.w3.org/2000/svg"
